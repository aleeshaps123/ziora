...
SECRET_KEY = 'django-insecure-$$*$oart+xrw#+ti=9i0k%q6t&ff*fw_bipxkeq7yy+jw_*#@z'
...
EMAIL_HOST_PASSWORD = 'pkqq kjxs jzqx tlcz'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'saree/static'),  # This includes your static files during development
]
